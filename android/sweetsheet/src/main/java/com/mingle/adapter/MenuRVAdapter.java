...
public class MenuRVAdapter extends RecyclerView.Adapter<MenuRVAdapter.MenuVH> {
    ...
    public void onBindViewHolder(MenuVH menuVH, int i) {
        ...
        menuVH.addressTV.setText(menuEntity.address);
        menuVH.addressTV.setTextColor(menuEntity.addressColor);
        menuVH.scoreTV.setText(menuEntity.score);
        menuVH.scoreTV.setTextColor(menuEntity.scoreColor);
        if (mIsAnimation) {
            animation(menuVH);
        }
    }
